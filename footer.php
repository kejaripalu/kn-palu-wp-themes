        ...
        <a href="<?php echo home_url(); ?>" class="site-logo" style="display:inline-flex;margin-bottom:1rem;">
          ...
          <?php endif; ?>
            <div class="logo-text">
              ...
              <span class="logo-sub">Website Resmi Kejaksaan Negeri Palu</span>
            </div>
          </a>

          <div class="footer-social" style="margin:1rem 0;">
            <?php
              $ig = kejari_get('instagram');
              $yt = kejari_get('youtube');
              $fb = kejari_get('facebook');
            ?>
            <a href="<?php echo esc_url( $ig ? $ig : 'https://www.instagram.com/kejaripalu' ); ?>" class="social-link" target="<?php echo $ig ? '_blank' : '_self'; ?>" <?php echo $ig ? 'rel="noopener noreferrer"' : ''; ?> aria-label="Instagram">
            ...
            <a href="<?php echo esc_url( $yt ? $yt : 'https://www.youtube.com/@kejaripaluu' ); ?>" class="social-link" target="<?php echo $yt ? '_blank' : '_self'; ?>" <?php echo $yt ? 'rel="noopener noreferrer"' : ''; ?> aria-label="YouTube">
              <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>
            </a>
            <a href="<?php echo esc_url( $fb ? $fb : 'https://www.facebook.com/KejariPalu' ); ?>" class="social-link" target="<?php echo $fb ? '_blank' : '_self'; ?>" <?php echo $fb ? 'rel="noopener noreferrer"' : ''; ?> aria-label="Facebook">
